...
@php
    $repeaterConfigs = [
        ...
        'highlights' => ['name' => 'highlight_items', 'fields' => ['title_en', 'title_ar', 'description_en', 'description_ar', 'icon', 'image_file', 'existing_image', 'remove_image', 'sort_order', 'is_active']],
