...
<form method="post" action="{{ route('admin.header-settings.update') }}" enctype="multipart/form-data">
    ...
    <div class="card admin-card p-4 mb-4">
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                @if($setting->logoUrlFor('header'))
                    <div class="mt-3 p-3 border rounded-4 bg-light">
                        <img src="{{ $setting->logoUrlFor('header') }}" alt="{{ $setting->localized('site_name') ?: 'Travel Wave' }}" class="img-fluid" style="max-height: 72px; object-fit: contain;">
                    </div>
                @else
            ...
            <div class="col-md-3"><label class="form-label">Logo Width</label><input class="form-control" type="number" name="logo_width" value="{{ old('logo_width', $setting->logo_width ?: 220) }}"></div>
            <div class="col-md-3"><label class="form-label">Logo Height</label><input class="form-control" type="number" name="logo_height" value="{{ old('logo_height', $setting->logo_height) }}"></div>
            <div class="col-md-3"><label class="form-label">Mobile Logo Width</label><input class="form-control" type="number" name="mobile_logo_width" value="{{ old('mobile_logo_width', $setting->mobile_logo_width ?: 168) }}"></div>
