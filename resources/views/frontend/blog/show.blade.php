...
<article class="container py-5">
    <div class="tw-card tw-blog-article overflow-hidden">
        @if($post->featured_image)<img src="{{ asset('storage/' . $post->featured_image) }}" class="img-fluid w-100 tw-blog-cover" alt="{{ $post->localized('title') }}">@endif
        <div class="p-4 p-lg-5 tw-section-shell tw-reading-width">
            ...
            <div class="lh-lg tw-article-body">{!! nl2br(e($post->localized('content'))) !!}</div>
        </div>
    </div>
</article>
