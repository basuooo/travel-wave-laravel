...
class PageController extends Controller
{
    ...
    protected function pageSectionsFromRequest(Request $request, string $key, array $existing): array
    {
        ...
        $sections = match ($key) {
            ...
            'france-3' => $this->france3SectionsFromRequest($request, $existing),
            default => [
    ...
    protected function france3SectionsFromRequest(Request $request, array $existing): array
    {
        return [
            ...
            'quick_summary' => [
                ...
                'items' => $this->mapLocalizedRows((array) $request->input('france3_qs_items', []), ['label', 'value'], ['icon'], ['is_active'], ['sort_order']),
            ],
            'intro' => [
            ...
            'requirements' => [
                ...
                'items' => $this->mapLocalizedRows((array) $request->input('france3_req_items', []), ['title', 'text'], ['icon'], ['is_active'], ['sort_order']),
            ],
            'services' => [
                ...
                'items' => $this->mapLocalizedRows((array) $request->input('france3_service_items', []), ['title', 'text'], ['icon'], ['is_active'], ['sort_order']),
            ],
            'steps' => [
                ...
                'items' => $this->mapLocalizedRows((array) $request->input('france3_step_items', []), ['title', 'text'], ['step_number'], ['is_active'], ['sort_order']),
            ],
            'why_choose' => [
                ...
                'items' => $this->mapLocalizedRows((array) $request->input('france3_why_items', []), ['title', 'text'], ['icon'], ['is_active'], ['sort_order']),
            ],
            'suitability' => [
            ...
            'faq' => [
                ...
                'items' => $this->mapLocalizedRows((array) $request->input('france3_faq_items', []), ['question', 'answer'], [], ['is_active'], ['sort_order']),
            ],
            'notice' => [
