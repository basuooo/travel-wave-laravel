...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('lp_new_assets')) {
            Schema::create('lp_new_assets', function (Blueprint $table) {
                ...
                $table->string('asset_type', 50)->default('image'); // image, svg, font, css, js, other
    ...
    {
        Schema::dropIfExists('lp_new_activity_logs');
        Schema::dropIfExists('lp_new_page_variants');
        Schema::dropIfExists('lp_new_experiments');
        Schema::dropIfExists('lp_new_assets');
        Schema::dropIfExists('lp_new_page_versions');
        Schema::dropIfExists('lp_new_landing_pages');
        Schema::dropIfExists('lp_new_global_components');
        Schema::dropIfExists('lp_new_sections');
        Schema::dropIfExists('lp_new_section_categories');
        Schema::dropIfExists('lp_new_templates');
        Schema::dropIfExists('lp_new_template_categories');
        Schema::dropIfExists('lp_new_brand_domains');
        Schema::dropIfExists('lp_new_brands');
    }
};
