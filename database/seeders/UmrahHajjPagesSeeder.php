...
class UmrahHajjPagesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        // 3. ADD UMRAH & HAJJ TO HEADER MENU
        $umrahMenuItem = MenuItem::updateOrCreate(
            ['location' => 'header', 'title_ar' => 'رحلات العمرة'],
            [
                'location' => 'header',
                'parent_id' => null,
                'type' => 'page',
                'page_id' => $umrahPage->id,
        ...
        $hajjMenuItem = MenuItem::updateOrCreate(
            ['location' => 'header', 'title_ar' => 'رحلات الحج'],
            [
                'location' => 'header',
                'parent_id' => null,
                'type' => 'page',
