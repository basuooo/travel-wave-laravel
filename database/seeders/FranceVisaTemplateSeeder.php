...
class FranceVisaTemplateSeeder extends Seeder
{
    public function run()
    {
        ...
        $country = VisaCountry::query()->updateOrCreate(
            ...
            [
                ...
                'name_en' => 'France',
                'name_ar' => 'فرنسا',
                'excerpt_en' => 'France visa is one of the most requested Schengen visas for tourism, family visits, and selected business travel, usually allowing stays of up to 90 days within 180 days. Travel Wave helps applicants organize the file, review documents, align bookings, and understand the process, fees, and expected timeline more clearly.',
                'excerpt_ar' => 'دعم احترافي من Travel Wave لتجهيز تأشيرة فرنسا شنغن ومراجعة الملف والحجوزات والمتابعة.',
                'hero_badge_en' => 'Schengen Visa Support',
                'hero_badge_ar' => 'دعم تأشيرة شنغن',
                'hero_title_en' => 'France Visa Services Built for Clarity and Confidence',
                'hero_title_ar' => 'خدمات تأشيرة فرنسا المصممة بوضوح وثقة',
                'hero_subtitle_en' => 'From the first checklist to the final submission, Travel Wave helps travelers prepare a stronger France visa file with premium guidance.',
                'hero_subtitle_ar' => 'من أول قائمة مستندات حتى التقديم النهائي تساعدك Travel Wave على تجهيز ملف فرنسا بشكل أوضح وأكثر احترافية.',
                'hero_cta_text_en' => 'Start Your France Visa Request',
                ...
                'why_choose_intro_en' => 'A premium support experience built to make the France visa process clearer, more organized, and easier to follow.',
                'why_choose_intro_ar' => 'تجربة دعم احترافية تجعل مسار تأشيرة فرنسا أوضح وأكثر تنظيما وأسهل في المتابعة.',
                'why_choose_items' => [
                ...
                'documents_subtitle_en' => 'The exact file may vary by profile, but these are the most common documents requested for France tourist visa preparation.',
                'documents_subtitle_ar' => 'قد يختلف الملف بحسب حالة المتقدم، لكن هذه هي المستندات الأكثر شيوعا لتجهيز تأشيرة فرنسا السياحية.',
                'document_items' => [
                ...
                'support_subtitle_en' => 'Talk to Travel Wave and get practical guidance on documents, bookings, and the best next step for your France visa file.',
                'support_subtitle_ar' => 'تحدث مع Travel Wave واحصل على إرشاد عملي بخصوص المستندات والحجوزات وأفضل خطوة تالية لملف تأشيرة فرنسا.',
                ...
                'faqs' => [
                    ['question_en' => 'Is France visa considered a Schengen visa?', 'question_ar' => 'هل تأشيرة فرنسا تعتبر تأشيرة شنغن؟', 'answer_en' => 'Yes. In most travel cases, the France short-stay visa is processed under Schengen rules.', 'answer_ar' => 'نعم. في أغلب حالات السفر تتم معالجة تأشيرة فرنسا قصيرة الإقامة ضمن نظام شنغن.', 'sort_order' => 1, 'is_active' => true],
                ...
                'map_embed_code' => '<iframe src="https://www.google.com/maps?q=Paris%20France&output=embed" width="100%" height="420" style="border:0;" loading="lazy"></iframe>',
                'map_is_active' => true,
                'inquiry_form_title_en' => 'Talk to Travel Wave About Your France Visa',
                'inquiry_form_label_en' => 'Contact Us',
                'inquiry_form_label_ar' => 'تواصل معنا',
                'inquiry_form_title_ar' => 'تواصل مع Travel Wave بخصوص تأشيرة فرنسا',
                ...
                'inquiry_form_button_en' => 'Send France Visa Inquiry',
                'inquiry_form_button_ar' => 'أرسل استفسار تأشيرة فرنسا',
                'inquiry_form_success_en' => 'Your France visa inquiry has been received. A Travel Wave advisor will contact you shortly.',
                'inquiry_form_success_ar' => 'تم استلام استفسارك الخاص بتأشيرة فرنسا وسيتواصل معك أحد مستشاري Travel Wave قريبا.',
                'inquiry_form_default_service_type' => 'France Visa',
                ...
                'cta_title_en' => 'Ready to Start Your France Visa File?',
                'cta_title_ar' => 'جاهز لبدء ملف تأشيرة فرنسا؟',
