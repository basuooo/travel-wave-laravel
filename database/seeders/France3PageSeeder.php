...
class France3PageSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        Page::updateOrCreate(
            ...
            [
                'key' => 'france-3',
                'title_ar' => 'فرنسا 3 - فيزا فرنسا 🇫🇷',
                'title_en' => 'France 3 - France Visa 🇫🇷',
                'slug' => 'france-3',
                ...
                'hero_subtitle_en' => 'At Travel Wave, we help you prepare your France visa file and submission steps.',
                ...
                'intro_title_ar' => 'نبذة عن فيزا فرنسا',
                'intro_title_en' => 'About France Visa',
                'intro_body_ar' => 'فيزا فرنسا قصيرة الإقامة هي تأشيرة شنغن تسمح بالسفر إلى فرنسا ودول منطقة الشنغن وفق مدة وشروط التأشيرة.',
                ...
                'meta_title_ar' => 'فرنسا 3 | فيزا شنغن فرنسا بأسلوب سهل واحترافي - ترافل ويف',
                'meta_title_en' => 'France 3 | France Schengen Visa Services - Travel Wave',
                'meta_description_ar' => 'احصل على فيزا فرنسا شنغن مع ترافل ويف. نساعدك في تقييم حالتك، تجهيز المستندات، مراجعة الملف وحجز المواعيد بأسلوب راقٍ واحترافي.',
                'meta_description_en' => 'Get your France Schengen visa with Travel Wave. Case assessment, file review, document organization, and appointment assistance.',
                'is_active' => true,
            ]
        );
    }
